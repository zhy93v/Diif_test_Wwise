...
using UAkInitializationSettings = UAkXboxSeriesXInitializationSettings;

struct FAkXSXPlatform : FAkPlatformBase
{
	static const UAkInitializationSettings* GetInitializationSettings()
	{
		return GetDefault<UAkXboxSeriesXInitializationSettings>();
	}

	static const FString GetPlatformBasePath()
	{
		return FString("XboxSeriesX");
	}
};

using FAkPlatform = FAkXSXPlatform;
